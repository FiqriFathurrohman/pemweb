...
<head>
	<meta charset="utf-8">
	<title><?php echo e($title ?? 'Pemweb'); ?></title>
	...
	<nav class="navbar navbar-expand-xl navbar-light text-center py-3">
		<div class="container">
			<a class="navbar-brand" href="<?php echo e(route('home')); ?>">
				<img loading="prelaod" decoding="async" class="img-fluid" width="160" src="<?php echo e(asset ('front/images/logo.png')); ?>" alt="Wallet">
			</a>
			<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span>
			</button>
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav m-auto mb-2 mb-lg-0">
					<li class="nav-item"> <a wire:navigate class="nav-link" href="<?php echo e(route ('home')); ?>">Home</a></li>
                    <li class="nav-item"> <a wire:navigate class="nav-link" href="<?php echo e(route ('profile')); ?>">Profile</a></li>
                    <li class="nav-item"> <a wire:navigate class="nav-link" href="<?php echo e(route ('about')); ?>">About</a></li>
				</ul>
			</div>
		</div>
	</nav>
...
<footer class="section-sm bg-tertiary">
	<div class="container">
        <div class="container d-flex justify-content-center">
            <a wire:navigate href="<?php echo e(route ('home')); ?>"> Copyright 2025</a>
        </div>
	</div>
</footer>
