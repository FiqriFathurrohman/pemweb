    ...
    <div class="row align-items-center justify-content-center">
      <div class="col-lg-6 mb-5 mb-lg-0">
        <div class="block text-center text-lg-start pe-0 pe-xl-5">
          <h1 class="text-capitalize mb-4"><?php echo e($config->title ?? ''); ?></h1>
          <p class="mb-4"><?php echo e($config->description ?? ''); ?></p> <a type="button"
...
</main><?php /**PATH /var/www/html/resources/views/livewire/show-home-page.blade.php ENDPATH**/ ?>